...
def main():
    ...
    wkt = 'POLYGON (( 39.41750000 21.44833333, 39.23416667 22.33555556, 40.28472222 22.51555556, 40.46750000 21.63138889, 39.41750000 21.44833333))'
    ...
    for folder in os.listdir(path):
        ...
        thermaremoved = do_thermal_noise_removal(sentinel_1)
        ...
        if down is None:
            ...
            ProductIO.writeProduct(down_subset, outpath + '/' + folder[:-5], 'GeoTIFF')
            del down_subset
	else:
            print("Error.")
